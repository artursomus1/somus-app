...
export const MODULE_PAGES: Record<ModuleName, PageDef[]> = {
  ...
  corporate: [
    { key: 'dashboard', label: 'Dashboard', icon: 'LayoutDashboard' },
    { key: 'simulador', label: 'Dados do Consórcio', icon: 'Calculator' },
    { key: 'fluxo-financeiro', label: 'Fluxo Financeiro', icon: 'Table' },
    { key: 'parcelas', label: 'Parcelas', icon: 'List' },
    { key: 'comparativo-vpl', label: 'Comparativo VPL', icon: 'TrendingUp' },
    { key: 'consorcio-vs-financ', label: 'Cons. vs Financ.', icon: 'Layers' },
    { key: 'grafico', label: 'Gráfico', icon: 'LineChart' },
    { key: 'resumo-cliente', label: 'Resumo Cliente', icon: 'FileText' },
